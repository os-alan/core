...
function initTabBar() {
    ...
    tabBars[1].onclick = function(event) {
        var isTutorialTab = event.content.getAttribute('name') === 'Tutorial';
        document.getElementById('page-panel').style.display = isTutorialTab ? 'block' : 'none';
    };
}
